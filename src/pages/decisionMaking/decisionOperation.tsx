...
import { update, getEarlyWaring, getEarlyWaringOptionOnRedux, getEarlyWaringReturnOnRedux } from '@/pages/earlyWarning/service';
import type { ReactElement } from "react";

const Operation = (props: { firstLevelPathKey: string, decisionSubmit: Function }): ReactElement => {
  const { firstLevelPathKey, decisionSubmit } = props;
