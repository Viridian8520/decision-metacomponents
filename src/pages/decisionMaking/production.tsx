...
import { getEarlyWaringOptionOnRedux, getProductionDecision } from './service';
...
const production: FC = (): ReactElement => {
  ...
  const { earlyWarningOption } = getEarlyWaringOptionOnRedux("production");
  let formData: any = earlyWarningOption || {
    categories: undefined,  // 生产链
